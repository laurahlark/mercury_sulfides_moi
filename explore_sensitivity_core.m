...
fprintf("Low and high q\t\t rho: %g %g %g, C: %g %g %g\n", ...
    rho_lo, rho, rho_hi, C_lo, C, C_hi);
...
fprintf("Extreme R_c and P_c\t\t rho: %g %g %g, C: %g %g %g\n", ...
    rho_lo, rho, rho_hi, C_lo, C, C_hi);
