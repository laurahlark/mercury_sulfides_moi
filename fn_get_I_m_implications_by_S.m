function [rho_c_extracted, R_c_extracted, rho_c_dispersed, R_c_dispersed, m_frac_S]=...
    ...
    [M_c_extracted, R_c_extracted] = fn_get_I_m_implications(...
        rho_silicate, rho_sulfide, m_frac_sulfide, false, I_m);
    rho_c_extracted = M_c_extracted./(4/3*pi*R_c_extracted.^3);

    [M_c_dispersed, R_c_dispersed] = fn_get_I_m_implications(...
