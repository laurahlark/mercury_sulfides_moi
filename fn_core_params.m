function core_params=fn_core_params(C, C_oss, rho_m, rho_S, rho_cr, R_S, R_m)
    R = 2439.36e3;
    M = 3.30111e23;
    G = 6.67408e-11;
    ...
    C_m = C_oss - 8*pi/15*rho_cr * (R^5-R_S^5) - 8*pi/15*rho_S * (R_S^5-R_m^5);
    R_c = (R_m^5 - 15/(8*pi)*C_m./rho_m)^(1/5);
